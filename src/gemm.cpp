...
#include <omp.h>
#endif
//#include "../testing_utilities/Adding_library/MathFunctions.h"
        ...
        float *C_gpu, int ldc)
{
    ...
    // #include "../Cutlass/include/cutlass/numeric_types.h"
    // #include "../Cutlass/include/cutlass/core_io.h"

    //sqrt_function();
    static int count_calls;
    printf("%d\t Here we are: M:%d\t N:%d\t K=%d\n",count_calls, M,N,K);
