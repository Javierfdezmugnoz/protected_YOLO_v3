...
int resize_network(network *net, int w, int h)
{
    ...
    if(gpu_index >= 0){
        // The following two lines has been modified by JFdez. I have allocated extra workspace (+1000000)
        printf(" try to allocate additional workspace_size = %1.2f MB \n", (float)workspace_size+1000 / 1000000);
        net->workspace = cuda_make_array(0, (workspace_size+1000)/sizeof(float) + 1);
