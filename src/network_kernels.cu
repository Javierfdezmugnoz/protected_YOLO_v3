...
// #define MAX_TIMING_MEASUREMENTS 10
...
void forward_network_gpu(network net, network_state state)
{
    ...
    // ======================================================================
    // static uint32_t current_layer = 0u;
    ...
    for(i = 0; i < net.n; ++i){
        ...
        // ======================================================================
        //                      TIME MEASUREMENTS: Chrono library
        // ======================================================================
        // if(l.type==0) {
        ...
        //     {
        //         execution_time[current_layer][current_measurement]= end_time - start_time;
        //     } else {

        //     }
        //     // printf("execution_time[layer=%d][measurement=%d]= %lf (ns)\n",current_layer, current_measurement, execution_time[current_layer][current_measurement]);
        //     current_layer++;
        // }
        // else 
        // {
...
*/
    ...
    //     for (size_t idx_layer = 0; idx_layer < MAX_LAYERS; idx_layer++)
    //     {
    //         fprintf(p_file,"L%d,",idx_layer+1);
    //         for (size_t idx_measurements = 10; idx_measurements < MAX_TIMING_MEASUREMENTS; idx_measurements++)
    //         {
    //             //printf("execution_time[measurement=%d][layer=%d]= %lf (ns)\n",idx_measurements,idx_layer, execution_time[idx_layer][idx_measurements]);
    //             fprintf(p_file,"%10.0lf,",execution_time[idx_layer][idx_measurements]);
    //         }
    //         fprintf(p_file,"\n");
    //     }
    //     fclose(p_file);
