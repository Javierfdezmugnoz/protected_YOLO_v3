    ...
    * ============================================================================================================== */
    ...
    const uint32_t kaui32_crc_table[CRC_TABLE_ELEMENTS] = 
    {
    ...
    #if ((INTERNAL_ES==CRC_CHECKSUM) || (INTERMEDIATE_ES==CRC_CHECKSUM) || (CRC_CHECKSUM==EXTERNAL_ES))
    //     //extern uint32_t kaui32_crc_table[];
    ...
    * ============================================================================================================== */
    ...
    /* ==========================================================================
        Descritption: XOR with ptx instructions
    =============================================================================*/
    ...
    /* ==========================================================================
        Descritption: Ones complement with ptx instructions
    =============================================================================*/
    ...
    /* ==========================================================================
        Descritption: Twos complement with ptx instructions
    =============================================================================*/
    ...
    __forceinline__ __host__ uint32_t h_singletable_crc32c_ui32(uint32_t *kaui32_crc_table, uint32_t ui32_crc, uint32_t ui32_data)
    {
        ui32_to_ui8_t u;
        u.ui32 = ui32_data;
