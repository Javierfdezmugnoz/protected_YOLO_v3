...
int main () {
    ...
    for (size_t idx_loop = 0; idx_loop < ui32_num_list_names; idx_loop++)
    {
        ...
        {
            printf("Correct predictions:%d in porcentage:%2.2f",ui32_qty_correct_images,(ui32_qty_correct_images/10000));
            printf("Correct predictions with new unexpected predictions:%d in porcentage:%2.2f",ui32_qty_almost_correct_images,(ui32_qty_almost_correct_images/10000));
        }
